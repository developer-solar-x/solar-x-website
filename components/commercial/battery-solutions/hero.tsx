    ...
    <section className="relative min-h-screen w-full flex items-center justify-center">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-32 sm:px-6 lg:px-8 text-center">
        <h1 className="text-5xl font-bold leading-tight text-white sm:text-6xl lg:text-7xl">
          Commercial <span className="text-[#ff4a4a]">Battery</span> Energy Storage Systems (BESS)
        </h1>
        <p className="mt-8 text-3xl font-medium text-white/90 max-w-4xl mx-auto">
          Stay powered and <span className="text-[#ff4a4a]">resilient</span> with reliable BESS, now with major rebates available.
        </p>
        <div className="mt-10">
          <Link href="#contact">
            <Button

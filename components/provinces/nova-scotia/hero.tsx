...
export function NovaScotiaHero() {
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/ontario.jpg')`,
        }}
      >
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-32 sm:px-6 lg:px-8 text-center">
        <h1 className="text-5xl font-bold leading-tight text-white sm:text-6xl lg:text-7xl">
          In <span className="text-[#ff4a4a]">Nova Scotia</span>
        </h1>
        ...
        <p className="mt-6 text-xl text-white/80">
          Affordable solar installations from #1 Canada solar company
        </p>
        <div className="mt-10">
          <Link href="/contact">
            <Button

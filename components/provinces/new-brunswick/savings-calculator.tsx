...
export function NewBrunswickSavingsCalculator() {
  const [province, setProvince] = useState<string>("nb")
  ...
  const calculateSavings = () => {
    ...
    const estimatedSystemSize = Math.max(35, Math.min(51, (annual / 1000) * 0.7))
  ...
  return (
    <section id="savings" className="bg-secondary py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-foreground sm:text-4xl">
            Calculate Your Potential Savings in New Brunswick
          </h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Discover the potential of your home with a solar solution. Estimate savings, unlock rebates & financing options now.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="monthly-cost">Enter your monthly utility cost</Label>

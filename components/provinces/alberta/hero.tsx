  ...
  return (
    <section className="relative min-h-screen w-full">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/ground-mounted-solar-array-in-green-field.jpg')`,
        }}
      >
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h1 className="text-5xl font-bold leading-tight text-white sm:text-6xl lg:text-7xl">
              In Alberta <span className="text-white">Customize Your Energy Solutions</span>
            </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="albertaFirstName" className="text-primary-foreground">
                    First Name
                  </Label>
                  <Input
                    id="albertaFirstName"
                ...
                <div className="space-y-2">
                  <Label htmlFor="albertaLastName" className="text-primary-foreground">
                    Last Name
                  </Label>
                  <Input
                    id="albertaLastName"
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="albertaEmail" className="text-primary-foreground">
                    Email
                  </Label>
                  <Input
                    id="albertaEmail"
                ...
                <div className="space-y-2">
                  <Label htmlFor="albertaPhone" className="text-primary-foreground">
                    Phone Number
                  </Label>
                  <Input
                    id="albertaPhone"
              ...
              <div className="space-y-2">
                <Label htmlFor="albertaMessage" className="text-primary-foreground">
                  Message (Optional)
                </Label>
                <Textarea
                  id="albertaMessage"
              ...
              <div className="flex items-start space-x-3">
                ...
                />
                <Label htmlFor="albertaSubscribe" className="text-sm leading-relaxed text-primary-foreground/80">
